        ...
        <nav
            ...
            <div className='w-full px-[0.75rem] flex justify-between items-center lg:w-[80%]  lg:mx-auto '>
                ...
                <div className='mr-[3rem] lg:flex lg:mr-0 lg:gap-[12.5px] lg:items-center'>
                    <button className='underline hover:text-gray' onClick={props.onLoginBtnClick}>Log In</button>
                </div>
            </div>
            <div>
            <img src={menu} onClick={toggleNav} className='w-[40px] h-[40px] absolute top-[0.75rem] right-[0.75rem] cursor-pointer lg:hidden ' alt="burger menu icon "/>            </div>
        </nav>
    )
